...
- `positive` #1: `linear_mc_0028` (monte_carlo) fairness_gap=0.092260910064406131829489040
- `positive` #2: `linear_mc_0028` (monte_carlo) fairness_gap=0.092260910064406131829489040
...
- `negative` #1: `linear_mc_0010` (monte_carlo) fairness_gap=-1.364474562074663320104205924
- `negative` #2: `linear_mc_0010` (monte_carlo) fairness_gap=-1.364474562074663320104205924
- `negative` #3: `linear_mc_0000` (monte_carlo) fairness_gap=-1.273078474177185535058006654
- `negative` #4: `linear_mc_0000` (monte_carlo) fairness_gap=-1.273078474177185535058006654
- `negative` #5: `linear_mc_0019` (monte_carlo) fairness_gap=-1.195645161781052846569305579
- `absolute` #1: `linear_mc_0010` (monte_carlo) fairness_gap=-1.364474562074663320104205924

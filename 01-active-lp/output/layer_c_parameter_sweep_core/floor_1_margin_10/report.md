...
- `positive` #3: `sweep_floor_1_margin_10_adv_0026` (adversarial) fairness_gap=0.1030036798608631487107382268
- `positive` #4: `sweep_floor_1_margin_10_adv_0058` (adversarial) fairness_gap=0.1014502813770336484498351865
- `positive` #5: `sweep_floor_1_margin_10_adv_0026` (adversarial) fairness_gap=0.1013818647304912334936279088
- `negative` #1: `sweep_floor_1_margin_10_adv_0027` (adversarial) fairness_gap=-0.0611068760198373333840159197
- `negative` #2: `sweep_floor_1_margin_10_adv_0059` (adversarial) fairness_gap=-0.0599764144382116280161425843
- `negative` #3: `sweep_floor_1_margin_10_adv_0027` (adversarial) fairness_gap=-0.0594848747546575571683110360
- `negative` #4: `sweep_floor_1_margin_10_adv_0059` (adversarial) fairness_gap=-0.0593426751442028305820301509
- `negative` #5: `sweep_floor_1_margin_10_adv_0049` (adversarial) fairness_gap=-0.0553796248386019507090109061
